...
public class Triangle extends Shape {
    ...
    public Triangle(Point start, Point end, Color borderColor, Color fillColor) {
    ...
    public void drawShape(Graphics g, Point startingPoint, Point endingPoint) {
        //Not dividing by 2 will create a right triangle
        triangleArrayX[0] = startingPoint.x + (Math.abs(startingPoint.x - endingPoint.x) / 2);
