...
public class MainPanel extends JPanel {
    ...
    private final ImageIcon blackImage = new ImageIcon("icons\\Black.jpg");
    private final ImageIcon greyImage = new ImageIcon("icons\\Grey.png");
    private final ImageIcon redImage = new ImageIcon("icons\\Red.png");
    private final ImageIcon rubyImage = new ImageIcon("icons\\Ruby.png");
    private final ImageIcon orangeImage = new ImageIcon("icons\\Orange.png");
    private final ImageIcon yellowImage = new ImageIcon("icons\\Yellow.png");
    private final ImageIcon greenImage = new ImageIcon("icons\\Green.png");
    private final ImageIcon turquoiseImage = new ImageIcon("icons\\Turquoise.jpg");
    private final ImageIcon blueImage = new ImageIcon("icons\\Blue.png");
    private final ImageIcon whiteImage = new ImageIcon("icons\\White.png");
    private final ImageIcon lightGreyImage = new ImageIcon("icons\\LightGrey.png");
    private final ImageIcon lightBrownImage = new ImageIcon("icons\\LightBrown.png");
    private final ImageIcon pinkImage = new ImageIcon("icons\\Pink.png");
    private final ImageIcon coralImage = new ImageIcon("icons\\Coral.png");
    private final ImageIcon blueGreyImage = new ImageIcon("icons\\BlueGrey.png");
    private final ImageIcon darkSeaGreenImage = new ImageIcon("icons\\DarkSeaGreen.png");
    private final ImageIcon violetImage = new ImageIcon("icons\\Violet.png");
    private final ImageIcon lavenderImage = new ImageIcon("icons\\Lavender.png");
    ...
    private final ImageIcon lineImage = new ImageIcon("icons\\Line.jpg");
    private final ImageIcon ovalImage = new ImageIcon("icons\\Oval.png");
    private final ImageIcon circleImage = new ImageIcon("icons\\Circle.png");
    private final ImageIcon rectangleImage = new ImageIcon("icons\\Rectangle.png");
    private final ImageIcon squareImage = new ImageIcon("icons\\Square.png");
    private final ImageIcon rightTriangleImage = new ImageIcon("icons\\RightTriangle.png");
    private final ImageIcon parallelogramImage = new ImageIcon("icons\\Parallelogram.png");
    private final ImageIcon rhombusImage = new ImageIcon("icons\\Rhombus.png");
    private final ImageIcon polygonImage = new ImageIcon("icons\\Polygon.png");
    private final ImageIcon hexagonImage = new ImageIcon("icons\\Hexagon.png");
    private final ImageIcon starImage = new ImageIcon("icons\\Star.png");
    ...
    public MainPanel() {
        ...
        ImageIcon triangleImage = new ImageIcon("icons\\Triangle.png");
