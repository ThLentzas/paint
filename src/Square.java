...
public class Square extends Shape {
    ...
    public Square(Point start, Point end, Color borderColor, Color fillColor) {
    ...
    public void drawShape(Graphics g, Point start, Point end) {
        ...
        g.drawRoundRect(distX, distY, dist1, dist1, 16,16);
        if(fillColor != null) {
            g.setColor(fillColor);
            g.fillRoundRect(distX, distY, dist1, dist1, 16, 16);
